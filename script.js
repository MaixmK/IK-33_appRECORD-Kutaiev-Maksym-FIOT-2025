(function () {
  ...
  const lab1 = {
    ...
    theme: `
      ...
      <ul>
        <li><b>WEB-застосунок:</b> <code>index.html</code> (локально через Live Server: <code>http://127.0.0.1:5500/</code> або на хостингу).</li>
        <li><b>Звітний документ (ЛР1):</b> цей SPA-розділ «ЛР1» на поточній сторінці.</li>
      </ul>
    `,
