...
section2: `
<h2>2 Розроблення аадаптивного інтерфейсу Web-застосунку</h2>
...
<p>
У ході виконання лабораторної роботи було розроблено
<b>клієнтський веб-застосунок для онлайн-каталогу комп’ютерних комплектуючих</b>,
який демонструє застосування сучасних веб-технологій та принципів
побудови інтерактивних інтерфейсів.
</p>

<p>
Під час роботи було проаналізовано предметну область,
сформульовано функціональні та нефункціональні вимоги до системи,
а також спроєктовано логічну структуру веб-застосунку.
Реалізовано адаптивний інтерфейс, що коректно працює
на десктопних та мобільних пристроях.
</p>

<p>
У процесі розроблення закріплено практичні навички роботи з
<b>HTML5, CSS3 та JavaScript</b>, зокрема використання
Flexbox, CSS Grid, медіа-запитів, DOM-маніпуляцій та
обробки подій. Інтерфейс оновлюється динамічно без
перезавантаження сторінки, що відповідає сучасним вимогам
до користувацького досвіду.
</p>

<p>
За допомогою JavaScript реалізовано програмну логіку каталогу,
фільтрації, сортування, пагінації та кошика покупок.
Для збереження стану застосунку між сесіями використано
<b>LocalStorage</b>, що дозволило імітувати роботу серверної частини
та REST-взаємодії без використання бекенду.
</p>

<p>
Окрему увагу приділено реалізації бізнес-логіки:
керуванню станами інтерфейсу, валідації форм,
обмеженню некоректних дій користувача та
обробці складних сценаріїв взаємодії.
Також у проєкті реалізовано додатковий інтерактивний модуль —
<b>модальний калькулятор</b>, що демонструє розширюваність застосунку.
</p>

<p>
У ході виконання роботи набуто навичок використання
<b>системи контролю версій Git</b> та платформи <b>GitHub</b>,
організації структури репозиторію, створення логічно обґрунтованих
комітів і підготовки супровідної документації.
</p>

<p>
Результатом виконання лабораторної роботи є повнофункціональний
веб-застосунок, який може бути використаний як основа
для подальшого розвитку, зокрема підключення реального REST API,
серверної частини, системи ролей користувачів та механізмів
